    ...
    <div className="min-h-screen bg-gray-100 flex items-center justify-center px-4">
      <div className="bg-white rounded-2xl shadow-xl max-w-md w-full p-8">
        ...
        <div className="space-y-6 mb-8">
          {/* Service Items */}
          <div>
            <h3 className="text-lg font-semibold text-gray-800 mb-3">รายการบริการ</h3>
            <div className="space-y-2">
              {cartItems.length > 0 ? (
                ...
                <div className="text-center py-4">
                  <p className="text-gray-500">ไม่พบข้อมูลรายการบริการในหน่วยความจำ</p>
                  <p className="text-sm text-gray-400 mt-1">กรุณาตรวจสอบอีเมลเพื่อดูรายละเอียดการจอง</p>
                </div>
              )}
            </div>
          </div>
        ...
        <Button
          ...
          className="w-full bg-blue-600 hover:bg-blue-700 text-white py-3 rounded-lg font-medium text-lg transition-colors duration-200 cursor-pointer"
        >
          เสร็จเรียบร้อย
        </Button>
