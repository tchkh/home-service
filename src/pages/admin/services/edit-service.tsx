         ...
         >
            ...
            <header className="relative flex flex-row justify-between items-center h-24 pl-12 pr-15 py-5 bg-[var(--white)]">
               ...
               <div className="flex items-center space-x-4">
                  ...
                  <div>
                     <span className="text-[var(--gray-700)] text-body-4">
                        บริการ
                     </span>
            ...
            <section className="flex flex-col gap-[40px] w-[90%] max-w-[95%] mx-auto px-5 py-10 bg-[var(--white)] border-1 border-[var(--gray-200)] rounded-2xl shadow-lg overflow-hidden">
               ...
               <section className="flex flex-col justify-start gap-10 space-y-2">
                        ...
                        >
                           <div className="flex flex-col col-span-4">
                              ...
                              <Input
                                 autoComplete="off"
                                 {...register(
                                    `sub_services.${idx}.title` as const,
                                    {
                                       required: true,
                                    }
                                 )}
                                 defaultValue={
                                    serviceData?.sub_services[idx]?.title
                                 }
                              />
                           ...
                           <div className="flex flex-col col-span-2">
                              ...
                              <Input
                                 autoComplete="off"
                                 {...register(
                                    `sub_services.${idx}.price` as const,
                                    {
                                       required: true,
                                       valueAsNumber: true,
                                    }
                  ...
                  <Button
                     ...
                     onClick={() =>
                        append({ title: "", price: 0, service_unit: "" })
                     }
                  >
                     เพิ่มรายการ +
                  </Button>
